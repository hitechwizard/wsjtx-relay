...
var DateField = {
  ...
  encode: function (value) {
    return dateformat(new Date(value), 'UTC:yyyymmdd');
  },
};
...
module.exports = {
  ...
  app_qrzlog_success: BooleanField,
  app_qrzlog_submitted_at: StringField,
  app_qrzlog_error_message: StringField,
  app_qrzlog_log_id: StringField,
  app_clublog_success: BooleanField,
  app_clublog_submitted_at: StringField,
  app_clublog_error_message: StringField,
  app_clublog_log_id: StringField,
